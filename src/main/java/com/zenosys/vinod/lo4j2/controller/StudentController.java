...
import com.zenosys.vinod.lo4j2.service.StudentService;
...
public class StudentController {
	...
	public Student getStudent(
			@ApiParam(value = "ID to be searched", required = true) @PathVariable final int id) {
	...
	public Student addStudent(
			@ApiParam(value = "Student to be inserted", required = true) @RequestBody final Student student) {
	...
	public Student updateStudent(
			@ApiParam(value = "ID to be updated", required = true) @PathVariable final int id,
			@ApiParam(value = "Student to be updated", required = true) @RequestBody final Student student) {
		student.setId(id);
		return studentService.saveStudent(student);
	}
	...
	public void deleteStudent(
			@ApiParam(value = "Student ID to be delete", required = true) @PathVariable final int id) {
